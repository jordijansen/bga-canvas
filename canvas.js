...
var ArtCardManager = /** @class */ (function (_super) {
    ...
    function ArtCardManager(canvasGame) {
        var _this = _super.call(this, canvasGame, {
            ...
            setupFrontDiv: function (card, div) {
                ...
                _this.canvasGame.setTooltip(div.id, _this.getTooltip(card));
            },
    ...
    ArtCardManager.prototype.getTooltip = function (card) {
        return "<div>\n                    <div class=\"title-wrapper\"><div class=\"title\"><h1>".concat(card.name, "</h1></div></div>\n                    <div class=\"art-card art-card-").concat(card.type_arg, "\"></div>\n               </div>");
    };
...
var ScoringCardManager = /** @class */ (function (_super) {
    ...
    ScoringCardManager.prototype.setUp = function (gameData) {
        ...
        gameData.scoringCards.forEach(function (card) { return _this.display.addCard(card).then(function () {
            _this.canvasGame.setTooltip(_this.getId(card), _this.formatDescription(_(card.description)));
        }); });
    };
    ...
    ScoringCardManager.prototype.formatDescription = function (description) {
        ...
        tags.forEach(function (originalTag) {
            if (originalTag.includes('icon-')) {
                ...
                tag = tag.replace('>', '');
                var resultTag = "<span class=\"canvas-element-icon ".concat(tag, "\"></span>");
...
var PaintingManager = /** @class */ (function () {
    ...
    PaintingManager.prototype.enterCompletePaintingMode = function (backgroundCards, artCards) {
        ...
        var _loop_4 = function (i) {
            dojo.place(this_2.createArtCardSlot(i), 'art-cards-picker');
...
var PlayerManager = /** @class */ (function () {
    ...
    PlayerManager.prototype.setUp = function (gameData) {
        ...
        players.forEach(function (player) {
            var playerArea = _this.createPlayerArea(player);
            if (Number(player.id) === _this.game.getPlayerId()) {
                playerAreas.unshift(playerArea);
            }
            else {
                playerAreas.push(playerArea);
            }
            _this.createPlayerPanels(player);
        });
        playerAreas.forEach(function (playerArea) { return dojo.place(playerArea, "player-areas"); });
    };
    PlayerManager.prototype.getOrderedPlayers = function (players) {
        var _this = this;
        var result = players.sort(function (a, b) { return Number(a.playerNo) - Number(b.playerNo); });
        var playerIndex = result.findIndex(function (player) { return Number(player.id) === Number(_this.game.player_id); });
...
var CARD_WIDTH = 250;
var CARD_HEIGHT = 425;
var INSPIRATION_TOKEN_WIDTH = 45;
var INSPIRATION_TOKEN_HEIGHT = 39;
